...
//                new Thread(new RunnableSimulationPetriGraph((PetriGraph) g, vv)).start();
            }
            JOptionPane.showMessageDialog(vv, "Hehe, zbyt skomplikowaną sieć byś chciał mieć, w tej wersji maksimum 10 wierzchołków.",
